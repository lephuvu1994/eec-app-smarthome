...
export default function SplashScreen() {
  ...
  return (
    <View className={"w-full flex-1 justify-center items-center relative"}>
      {/* {theme ==="dark" ? ( */}
      <Image style={{ width: '100%', height: '100%', position: 'absolute' }} source={require("@@/assets/base/dark-bg-image.png")} className="absolute w-full h-full" />
      {/* ) : null} */}
      <FocusAwareStatusBar hidden />
      <View
        className="absolute flex-1 w-full items-center justify-center"
        style={{
          top: insets.top,
      ...
      >
        ...
        <Animated.View
          className="items-center justify-center overflow-hidden -mt-32"
        ...
        <View className="-mt-3" style={{ width: iconWidth, alignItems: "flex-end" }}>
          <View className="justify-end">
            <View style={{ width: 130, overflow: "hidden" }}>
              <Animated.Text style={[styleTextOpacity]} className="text-xs text-yellow-500/70 italic font-semibold">
                Design by Euro Sol
              </Animated.Text>
            </View>
          </View>
        ...
        <View className="absolute bottom-0">
          <View className="justify-end overflow-hidden">
            <Text className="text-sm text-[#A5A5A5] dark:text-white font-semibold">v{Env.EXPO_PUBLIC_VERSION}</Text>
          </View>
        </View>
      </View>
    </View>
