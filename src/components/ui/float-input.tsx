...
const inputTv = tv({
  slots: {
    ...
    input:
      'z-10 bg-transparent px-4 py-4 font-eecfront text-base font-medium leading-5 text-white',
  },
  variants: {
    disabled: {
      true: {
        input: 'opacity-70 bg-white/10 rounded-xl',
      },
    },
  },
});
...
export const FloatInput = React.forwardRef<TextInput, NInputProps>(
  (props, ref) => {
    const {
      label,
      error,
    ...
    return (
      <View className={styles.container()}>
        ...
        >
          ...
          {rightIcon && (
            <View className="absolute right-4 top-0 bottom-0 justify-center z-20">
              {rightIcon}
            </View>
          )}
